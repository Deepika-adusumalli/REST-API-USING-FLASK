...
con_string = "mongodb+srv://Deepika:Deepika@cluster0.jppmddd.mongodb.net/?retryWrites=true&w=majority"
...
def project_api_routes(endpoints):
    ...
    def read_users():
        ...
        try:
            ...
            output = [{'Name' : user['name'], 'mail' : user['mail']} for user in users]   #list comprehension
            resp['data'] = output
        except Exception as e:
            print(e)
            status = {
